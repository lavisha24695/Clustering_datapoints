...
% Derived from Sanketh Shetty
function [pvals1, pvals2, pvals3] = isotropy_measures(data, win_size)
    ...
    data_dimensions = refine_dimension_estimates(data_dimensions, data_neighbors, params.method_refine,params.Krefine_dim);
    ...
    [data_coordinates,data_dimensions] = local_coordinate_assignment(data,data_dimensions,data_neighbors,params.Kper_dim,params.subspace); 


    pvals1 = isotropy_force_sum(data, data_dimensions, data_coordinates, data_neighbors, params);
    pvals2 = isotropy_force_sign(data, data_dimensions, data_coordinates, data_neighbors, params);
    pvals3 = isotropy_uniformity(data, data_dimensions, data_neighbors, data_coordinates, params);
